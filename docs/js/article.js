...
const renderLink = (json) => {
    ...
    links.forEach(link => {
        ...
        if (link['name-ja'] !== '') {
            ...
            articleTextP.textContent = link['description-ja'];
            ...
            if (link['venue-ja'] !== '') {
                ...
                venueHead.textContent = "会場";

                const venue = document.createElement('p');
                venue.className = 'info';
                venue.textContent = link['venue-ja'];
            ...
            if (link['event-dates-ja'] !== '') {
                ...
                eventDateHead.textContent = "開催期間";

                const eventDate = document.createElement('p');
                eventDate.className = 'info';
                eventDate.textContent = link['event-dates-ja'];
